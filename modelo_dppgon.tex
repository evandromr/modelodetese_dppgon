...
\include{info}  % Carrega o arquivo de informações: info.tex

% Carrega arquivo com outras configurações: setup.tex
\include{setup}

% IMPORTANTE: Para impressão mude a cor dos links de AZUL para PRETO
\definecolor{blue}{RGB}{41,5,195} % Links AZUIS -- apague ou comente essa linha para imprimir
...
% Resumo em Inglês
\include{pre-texto/abstract}       % obrigatório
...
\include{texto/part-introducao}
\include{texto/part-metodologia}
\include{texto/part-resultados}
\include{texto/part-conclusao}
...
\include{pos-texto/apendices}  % opcional
\include{pos-texto/anexos}     % opcional
